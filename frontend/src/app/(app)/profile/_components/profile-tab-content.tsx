...
export function ProfileTabContent() {
  ...
  return (
    <div className="relative flex flex-1 flex-col overflow-hidden">
        ...
        <div className="flex flex-col gap-5 px-4 pb-8 pt-4">
          ...
          <ProfileSection title="Account">
            ...
            <ProfileRow
              icon={Bot}
              label="AI Model"
              value={user?.preferred_model_id || "Platform Default"}
              onClick={() => setDrawer({ type: "modelSelector" })}
            />
      ...
      <ModelSelectorDrawer
        open={drawer.type === "modelSelector"}
        currentModelId={user?.preferred_model_id || null}
