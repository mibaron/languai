    ...
    vocab: [
      ...
      },
      {
        ...
        rows: [
          ...
          ["12 zwölf","13 dreizehn","14 vierzehn","15 fünfzehn","16 sechzehn","17 siebzehn"],
          ["18 achtzehn","19 neunzehn","20 zwanzig","21 einundzwanzig","30 dreißig","40 vierzig"],
  ...
  "A1.2": {
    grammar: [
      ...
      },
      {
        ...
        type: "table",
        headers: ["Gender", "Nominativ", "Akkusativ"],
        rows: [
          ["Maskulin ⚠", "mein Vater", "meinen Vater"],
          ["Feminin", "meine Mutter", "meine Mutter"],
      ...
      },
      {
        ...
        type: "table",
        headers: ["Verb", "du-form", "ihr-form", "Sie-form"],
        rows: [
      ...
      },
      {
        ...
        rows: [
          ...
          ["bei", "at / near / with (someone's place)", "Ich bin bei meiner Freundin."],
          ["nach", "after / to (cities/countries)", "Ich fahre nach Berlin."],
          ["seit", "since / for (time)", "Ich lerne seit zwei Jahren Deutsch."],
          ["von", "from / of / by", "Das ist ein Brief von meiner Mutter."],
          ["zu", "to (people/places)", "Ich gehe zum Arzt."],
          ["aus", "from (origin) / out of", "Ich komme aus Iran."],
      ...
      },
      {
        ...
        rows: [
          ...
          ["gegen", "against / around (time)", "Gegen 8 Uhr."],
          ["ohne", "without", "Kaffee ohne Zucker."],
          ["um", "around / at (time)", "Um 9 Uhr."],
        ],
      },
      {
        ...
        type: "table",
        headers: ["Konjunktion", "Meaning", "Example"],
        rows: [
          ["und", "and", "Ich arbeite und sie lernt."],
          ["oder", "or", "Kommst du oder bleibst du?"],
          ["aber", "but", "Ich möchte, aber ich kann nicht."],
          ["denn", "because / for", "Ich lerne Deutsch, denn ich brauche es."],
          ["sondern", "but rather (after negation)", "Ich trinke keinen Kaffee, sondern Tee."],
        ],
      },
      {
    ...
    vocab: [
      {
        ...
        type: "table",
        headers: ["Deutsch", "Plural", "English"],
        rows: [
          ...
          ["der Mann", "die Männer", "husband / man"],
          ["die Frau", "die Frauen", "wife / woman"],
          ["die Eltern", "(plural only)", "parents"],
          ["die Geschwister", "(plural only)", "siblings"],
          ["der Großvater / Opa", "die Großväter", "grandfather"],
          ["die Großmutter / Oma", "die Großmütter", "grandmother"],
        ],
      },
      {
        ...
        rows: [
          ...
          ["Es ist halb vier.", "It's half past three. (3:30)"],
    ...
    verbs: [
      {
        ...
        type: "table",
        headers: ["Infinitiv", "Meaning", "Partizip II", "Auxiliary"],
        rows: [
          ["aufräumen", "to tidy up", "aufgeräumt", "haben"],
          ["einladen", "to invite", "eingeladen", "haben"],
          ["anziehen", "to put on (clothes)", "angezogen", "haben"],
          ["ausziehen", "to take off / move out", "ausgezogen", "haben/sein"],
          ["fernsehen", "to watch TV", "ferngesehen", "haben"],
          ["besuchen", "to visit", "besucht", "haben"],
          ["helfen", "to help", "geholfen", "haben"],
          ["schlafen", "to sleep", "geschlafen", "haben"],
          ["bleiben", "to stay/remain", "geblieben", "sein"],
          ["reisen", "to travel", "gereist", "sein"],
          ["mögen", "to like", "gemocht", "haben"],
          ["brauchen", "to need", "gebraucht", "haben"],
        ],
      },
    ],
    phrases: [
    ...
    grammar: [
      {
        ...
        rows: [
          ["werden (pos.2) + Partizip II (end)", "Das Buch wird gelesen.", "The book is being read."],
          ["with agent: von + Dativ", "Das Buch wird von ihr gelesen.", "The book is being read by her."],
          ["ich werde + P.II", "Ich werde eingeladen.", "I am being invited."],
          ["du wirst + P.II", "Du wirst gefragt.", "You are being asked."],
          ["er/sie/es wird + P.II", "Er wird bezahlt.", "He is being paid."],
          ["wir werden + P.II", "Wir werden informiert.", "We are being informed."],
          ["ihr werdet + P.II", "Ihr werdet gerufen.", "You are being called."],
          ["sie/Sie werden + P.II", "Sie werden erwartet.", "They are being expected."],
        ],
      ...
      },
      {
        ...
        type: "table",
        headers: ["Präsens Passiv", "Präteritum Passiv", "Meaning"],
        rows: [
          ["wird gebaut", "wurde gebaut", "is/was being built"],
          ["wird geöffnet", "wurde geöffnet", "is/was being opened"],
          ["wird gemacht", "wurde gemacht", "is/was being done"],
          ["wird gefragt", "wurde gefragt", "is/was being asked"],
          ["wird eingeladen", "wurde eingeladen", "is/was being invited"],
        ],
      ...
      },
      {
        ...
        type: "table",
        headers: ["Pronomen", "Futur I", "Example"],
        rows: [
          ["ich", "werde + Inf.", "Ich werde morgen kommen."],
          ["du", "wirst + Inf.", "Du wirst es schaffen."],
          ["er/sie/es", "wird + Inf.", "Es wird regnen."],
          ["wir", "werden + Inf.", "Wir werden das lösen."],
          ["ihr", "werdet + Inf.", "Ihr werdet sehen."],
      ...
      },
      {
        ...
        type: "table",
        headers: ["Gender", "Definite Art.", "Indefinite Art.", "Noun ending", "Example"],
        rows: [
          ["Maskulin", "des", "eines", "+-(e)s", "das Auto des Mannes"],
          ["Feminin", "der", "einer", "no change", "die Tasche der Frau"],
          ["Neutrum", "des", "eines", "+-(e)s", "der Name des Kindes"],
          ["Plural", "der", "---", "no change", "die Bücher der Kinder"],
        ],
      ...
      },
      {
        ...
        type: "table",
        headers: ["Direct question", "Indirect question", "Conjunction"],
        rows: [
          ["Wo wohnt er?", "Ich weiß nicht, wo er wohnt.", "W-word"],
          ["Wann kommt sie?", "Ich frage mich, wann sie kommt.", "W-word"],
          ["Warum lernst du Deutsch?", "Er möchte wissen, warum du Deutsch lernst.", "W-word"],
          ["Kommt er? (yes/no)", "Ich weiß nicht, ob er kommt.", "ob"],
          ["Hat sie angerufen? (yes/no)", "Kannst du sagen, ob sie angerufen hat?", "ob"],
        ],
      ...
      },
      {
        ...
        type: "table",
        headers: ["Preposition", "da(r)- form", "wo(r)- form", "Example"],
        rows: [
          ["auf", "darauf", "worauf", "Ich warte darauf. — Worauf wartest du?"],
          ["für", "dafür", "wofür", "Ich bin dafür. — Wofür ist das gut?"],
          ["mit", "damit", "womit", "Ich bin damit einverstanden. — Womit schreibst du?"],
          ["über", "darüber", "worüber", "Wir reden darüber. — Worüber redet ihr?"],
          ["an", "daran", "woran", "Ich denke daran. — Woran denkst du?"],
          ["in", "darin", "worin", "Er liegt darin. — Worin liegt das Problem?"],
          ["von", "davon", "wovon", "Ich weiß davon nichts. — Wovon sprichst du?"],
          ["zu", "dazu", "wozu", "Was sagst du dazu? — Wozu brauchst du das?"],
        ],
      ...
      },
      {
        ...
        type: "table",
        headers: ["Verb + Prep.", "Case", "Example"],
        rows: [
          ...
          ["sich erinnern an", "Akk.", "Er erinnert sich an die Reise."],
          ["sich interessieren für", "Akk.", "Sie interessiert sich für Musik."],
          ["sich ärgern über", "Akk.", "Er ärgert sich über den Fehler."],
          ["sprechen über", "Akk.", "Wir sprechen über das Problem."],
          ["fragen nach", "Dat.", "Er fragt nach dem Weg."],
          ["suchen nach", "Dat.", "Ich suche nach meinem Schlüssel."],
          ["träumen von", "Dat.", "Sie träumt von einem Urlaub."],
          ["sich beschäftigen mit", "Dat.", "Er beschäftigt sich mit dem Thema."],
          ["gehören zu", "Dat.", "Das gehört zu meinen Aufgaben."],
      ...
      },
      {
        ...
        rows: [
          ["um … zu + Inf.", "in order to", "Ich lerne Deutsch, um in Deutschland zu arbeiten."],
          ["ohne … zu + Inf.", "without (doing)", "Er ging weg, ohne sich zu verabschieden."],
          ["(an)statt … zu + Inf.", "instead of (doing)", "Sie schläft, statt zu lernen."],
          ["damit + Nebensatz", "so that (different subject)", "Ich erkläre es langsam, damit er es versteht."],
          ["ohne dass + Nebensatz", "without (different subject)", "Er geht, ohne dass ich es bemerke."],
        ],
      ...
      },
      {
        ...
        headers: ["Case", "Maskulin", "Feminin", "Neutrum", "Plural"],
        rows: [
          ["Nominativ", "kalter Kaffee", "frische Milch", "heißes Wasser", "alte Bücher"],
          ["Akkusativ", "kalten Kaffee", "frische Milch", "heißes Wasser", "alte Bücher"],
          ["Dativ", "kaltem Kaffee", "frischer Milch", "heißem Wasser", "alten Büchern"],
        ],
      ...
      },
      {
        ...
        rows: [
          ["Allow / let", "Lass mich das machen.", "Let me do that."],
          ["Allow / let", "Er lässt sie gehen.", "He lets her go."],
          ["Have sth done (causative)", "Ich lasse mein Auto reparieren.", "I'm having my car repaired."],
          ["Have sth done (causative)", "Sie lässt sich die Haare schneiden.", "She's having her hair cut."],
          ["Leave sth somewhere", "Ich habe mein Handy zu Hause gelassen.", "I left my phone at home."],
        ],
      ...
      },
      {
        ...
        rows: [
          ["deshalb / deswegen", "therefore / that's why", "Es regnet. Deshalb bleiben wir zu Hause."],
          ["trotzdem", "nevertheless / despite that", "Es regnet. Trotzdem gehen wir spazieren."],
          ["außerdem", "besides / in addition", "Er ist klug. Außerdem ist er fleißig."],
          ["dennoch", "yet / still / nonetheless", "Es war schwer. Dennoch hat er es geschafft."],
          ["allerdings", "however / though", "Das klingt gut. Allerdings ist es teuer."],
          ["sonst", "otherwise / or else", "Beeil dich, sonst kommen wir zu spät."],
        ],
      ...
      },
      {
        ...
        type: "table",
        headers: ["Pronomen", "Meaning", "Example"],
        rows: [
          ["man", "one / you / people in general", "Man spricht hier Deutsch. (German is spoken here.)"],
          ["jemand", "someone / somebody", "Jemand hat angerufen."],
          ["niemand", "no one / nobody", "Niemand weiß die Antwort."],
          ["etwas", "something / some", "Ich möchte etwas essen."],
          ["nichts", "nothing", "Ich habe nichts verstanden."],
          ["alle", "all / everyone", "Alle sind gekommen."],
          ["alles", "everything", "Alles ist gut."],
          ["viele", "many (people/things)", "Viele lernen Deutsch."],
          ["wenige", "few (people/things)", "Wenige wissen das."],
          ["manche", "some / several", "Manche Leute mögen das."],
        ],
      ...
      },
      {
        ...
        rows: [
          ...
          ["Genitiv (whose)", "dessen", "deren", "dessen", "deren"],
        ],
    ...
    vocab: [
      {
        ...
        headers: ["Deutsch", "English"],
        rows: [
          ["der Beruf / die Stelle", "profession / position/job"],
          ["die Bewerbung / der Lebenslauf", "application / CV"],
          ["das Vorstellungsgespräch", "job interview"],
          ["der Arbeitgeber / Arbeitnehmer", "employer / employee"],
          ["die Ausbildung / das Studium", "vocational training / university studies"],
          ["das Gehalt / der Lohn", "salary / wage"],
          ["die Überstunden (pl.)", "overtime"],
          ["kündigen / entlassen werden", "to quit / to be fired"],
      ...
      },
      {
        ...
        headers: ["Deutsch", "English"],
        rows: [
          ["die Nachricht / die Meldung", "news item / report"],
          ["herunterladen / hochladen", "to download / to upload"],
          ["die App / die Website / das Netz", "app / website / internet"],
          ["drucken / speichern / löschen", "to print / to save / to delete"],
          ["die Datei / der Anhang", "file / attachment"],
          ["sich anmelden / abmelden", "to log in / to log out"],
          ["die Verbindung / der Akku", "connection / battery"],
        ],
      },
    ],
    verbs: [
      {
        ...
        type: "table",
        headers: ["Verb + Präp.", "Präteritum (ich)", "Partizip II", "Meaning"],
        rows: [
          ["warten auf (Akk.)", "wartete auf", "gewartet", "to wait for"],
          ["sich freuen auf (Akk.)", "freute mich auf", "gefreut", "to look forward to"],
          ["denken an (Akk.)", "dachte an", "gedacht", "to think of/about"],
          ["sich erinnern an (Akk.)", "erinnerte mich an", "erinnert", "to remember"],
          ["sich ärgern über (Akk.)", "ärgerte mich über", "geärgert", "to be annoyed about"],
          ["sprechen über (Akk.)", "sprach über", "gesprochen", "to talk about"],
          ["sich interessieren für (Akk.)", "interessierte mich für", "interessiert", "to be interested in"],
          ["träumen von (Dat.)", "träumte von", "geträumt", "to dream of"],
          ["gehören zu (Dat.)", "gehörte zu", "gehört", "to belong to"],
          ["lassen", "ließ", "gelassen", "to let / to have done"],
        ],
      },
    ],
    phrases: [
      {
        ...
        headers: ["Deutsch", "English"],
        rows: [
          ["Das wird (nicht) gemacht.", "That is (not) being done."],
          ["Es wurde gesagt, dass …", "It was said that …"],
      ...
      },
      {
        ...
        headers: ["Deutsch", "English"],
        rows: [
          ["Ich spare Geld, um ein Auto zu kaufen.", "I'm saving money in order to buy a car."],
          ["Er lernt viel, damit er besteht.", "He studies a lot so that he passes."],
          ["Sie ging ohne ein Wort zu sagen.", "She left without saying a word."],
          ["Statt zu lernen, schläft er.", "Instead of studying, he sleeps."],
          ["Es hat geregnet. Trotzdem sind wir gegangen.", "It rained. Nevertheless we went."],
          ["Ich war müde. Deshalb bin ich früh ins Bett.", "I was tired. That's why I went to bed early."],
        ],
      },
      {
        ...
        rows: [
          ...
          ["Ich bewerbe mich um die Stelle als …", "I am applying for the position of …"],
          ["Für Rückfragen stehe ich gern zur Verfügung.", "I am happy to answer any questions."],
        ],
      },
    ],
  },
    ...
    grammar: [
      {
        ...
        type: "table",
        headers: ["Pronomen", "machen (regular)", "arbeiten (stem ends -t/-d)"],
        rows: [
      ...
      },
      {
        ...
        type: "table",
        headers: ["Infinitiv", "ich", "du", "er/sie/es", "wir", "sie/Sie"],
        rows: [
          ["gehen", "ging", "gingst", "ging", "gingen", "gingen"],
          ["kommen", "kam", "kamst", "kam", "kamen", "kamen"],
          ["fahren", "fuhr", "fuhrst", "fuhr", "fuhren", "fuhren"],
          ["schreiben", "schrieb", "schriebst", "schrieb", "schrieben", "schrieben"],
          ["lesen", "las", "last", "las", "lasen", "lasen"],
          ["sprechen", "sprach", "sprachst", "sprach", "sprachen", "sprachen"],
          ["essen", "aß", "aßest", "aß", "aßen", "aßen"],
          ["trinken", "trank", "trankst", "trank", "tranken", "tranken"],
          ["schlafen", "schlief", "schliefst", "schlief", "schliefen", "schliefen"],
          ["stehen", "stand", "standst", "stand", "standen", "standen"],
          ["finden", "fand", "fandst", "fand", "fanden", "fanden"],
          ["nehmen", "nahm", "nahmst", "nahm", "nahmen", "nahmen"],
          ["geben", "gab", "gabst", "gab", "gaben", "gaben"],
          ["wissen", "wusste", "wusstest", "wusste", "wussten", "wussten"],
        ],
      },
      {
        ...
        type: "table",
        headers: ["Modal", "ich / er", "du", "wir / sie", "Meaning"],
        rows: [
          ...
          ["sollen", "sollte", "solltest", "sollten", "was supposed to"],
          ["mögen/möchten", "mochte", "mochtest", "mochten", "liked / wanted"],
        ],
      },
      {
      ...
      },
      {
        ...
        type: "table",
        headers: ["Case", "Maskulin", "Feminin", "Neutrum", "Plural (kein-)"],
        rows: [
          ["Nominativ", "ein alt-er Mann ⚠", "eine alt-e Frau", "ein alt-es Kind ⚠", "keine alt-en Kinder"],
          ["Akkusativ", "einen alt-en Mann", "eine alt-e Frau", "ein alt-es Kind", "keine alt-en Kinder"],
          ["Dativ", "einem alt-en Mann", "einer alt-en Frau", "einem alt-en Kind", "keinen alt-en Kindern"],
        ],
      ...
      },
      {
        ...
        rows: [
          ...
          ["gern", "lieber", "am liebsten", "gladly → prefer → like most"],
      ...
      },
      {
        ...
        headers: ["Konjunktion", "Meaning", "Example"],
        rows: [
          ["weil", "because (reason)", "Ich lerne Deutsch, weil ich in Deutschland arbeiten will."],
          ["dass", "that", "Ich glaube, dass er heute kommt."],
          ["wenn", "when / if (repeated/hypothetical)", "Wenn ich Zeit habe, gehe ich ins Kino."],
          ["ob", "whether / if (indirect yes/no question)", "Ich weiß nicht, ob er kommt."],
      ...
      },
      {
        ...
        rows: [
          ["an", "at / on (vertical)", "Das Bild hängt an der Wand.", "Ich hänge das Bild an die Wand."],
          ["auf", "on (horizontal)", "Das Buch liegt auf dem Tisch.", "Ich lege das Buch auf den Tisch."],
          ["in", "in / into", "Er ist in der Schule.", "Er geht in die Schule."],
          ["über", "over / above / across", "Die Lampe hängt über dem Tisch.", "Ich hänge die Lampe über den Tisch."],
          ["unter", "under / below", "Die Katze liegt unter dem Bett.", "Die Katze läuft unter das Bett."],
          ["vor", "in front of / ago", "Er steht vor dem Haus.", "Er stellt sich vor das Haus."],
          ["hinter", "behind", "Sie steht hinter der Tür.", "Sie geht hinter die Tür."],
          ["neben", "next to / beside", "Er sitzt neben mir.", "Er setzt sich neben mich."],
      ...
      },
      {
        ...
        type: "table",
        headers: ["Verb", "ich", "du", "er/sie/es", "wir", "sie/Sie", "Use"],
        rows: [
          ["würde+inf.", "würde", "würdest", "würde", "würden", "würden", "general polite/hypothetical"],
          ["können", "könnte", "könntest", "könnte", "könnten", "könnten", "ability / polite request"],
          ["haben", "hätte", "hättest", "hätte", "hätten", "hätten", "hypothetical having"],
          ["sein", "wäre", "wärst", "wäre", "wären", "wären", "hypothetical being"],
          ["müssen", "müsste", "müsstest", "müsste", "müssten", "müssten", "obligation (softer)"],
          ["dürfen", "dürfte", "dürftest", "dürfte", "dürften", "dürften", "permission (softer)"],
        ],
      ...
      },
      {
        ...
        headers: ["Case", "Maskulin", "Feminin", "Neutrum", "Plural"],
        rows: [
          ["Nominativ (subject of rel. clause)", "der", "die", "das", "die"],
          ["Akkusativ (object of rel. clause)", "den", "die", "das", "die"],
          ["Dativ (after dative prepositions)", "dem", "der", "dem", "denen"],
        ],
    ...
    vocab: [
      {
        ...
        headers: ["Deutsch", "English"],
        rows: [
          ["der Kopf / die Kopfschmerzen", "head / headache"],
          ["der Bauch / die Bauchschmerzen", "stomach / stomachache"],
          ["der Rücken / die Rückenschmerzen", "back / backache"],
          ["das Fieber haben", "to have a fever"],
          ["sich erkälten", "to catch a cold"],
          ["der Arzt / die Ärztin", "doctor (m/f)"],
          ["das Rezept", "prescription / recipe"],
          ["die Apotheke", "pharmacy"],
          ["Ich fühle mich nicht wohl.", "I don't feel well."],
          ["Mir ist schlecht / schwindelig.", "I feel sick / dizzy."],
        ],
      },
      {
        ...
        headers: ["Deutsch", "English"],
        rows: [
          ["die Wohnung / das Haus", "apartment / house"],
          ["das Zimmer / die Küche / das Bad", "room / kitchen / bathroom"],
          ["der Aufzug / die Treppe", "elevator / stairs"],
          ["geradeaus / links / rechts", "straight ahead / left / right"],
          ["an der Ampel / Kreuzung", "at the traffic light / intersection"],
          ["gegenüber / neben / hinter", "opposite / next to / behind"],
          ["Wie komme ich zu …?", "How do I get to …?"],
          ["Das ist in der Nähe von …", "That is near …"],
        ],
      },
    ],
    verbs: [
      {
        ...
        type: "table",
        headers: ["Infinitiv", "Präteritum (ich)", "Perfekt (ich)", "Meaning"],
        rows: [
          ["gehen", "ging", "bin gegangen", "to go"],
          ["kommen", "kam", "bin gekommen", "to come"],
          ["fahren", "fuhr", "bin gefahren", "to drive/travel"],
          ["fliegen", "flog", "bin geflogen", "to fly"],
          ["laufen", "lief", "bin gelaufen", "to run/walk"],
          ["bleiben", "blieb", "bin geblieben", "to stay"],
          ["schreiben", "schrieb", "habe geschrieben", "to write"],
          ["lesen", "las", "habe gelesen", "to read"],
          ["finden", "fand", "habe gefunden", "to find"],
          ["nehmen", "nahm", "habe genommen", "to take"],
          ["geben", "gab", "habe gegeben", "to give"],
          ["sehen", "sah", "habe gesehen", "to see"],
          ["stehen", "stand", "habe gestanden", "to stand"],
          ["liegen", "lag", "habe gelegen", "to lie/be located"],
          ["sich freuen", "freute sich", "hat sich gefreut", "to be happy/look forward"],
          ["sich fühlen", "fühlte sich", "hat sich gefühlt", "to feel"],
          ["sich erinnern", "erinnerte sich", "hat sich erinnert", "to remember"],
          ["versuchen", "versuchte", "habe versucht", "to try"],
          ["vergessen", "vergaß", "habe vergessen", "to forget"],
          ["beginnen", "begann", "habe begonnen", "to begin"],
        ],
      },
    ],
    phrases: [
      ...
      },
      {
        ...
        rows: [
          ...
          ["Dürfte ich kurz …?", "Might I briefly …?"],
      ...
      },
      {
        ...
        rows: [
          ...
          ["Früher hatte ich …", "In the past I had …"],
          ["Damals wohnte ich in …", "Back then I lived in …"],
          ["Ich konnte nicht kommen, weil …", "I couldn't come because …"],
          ["Er wollte, aber er musste arbeiten.", "He wanted to, but he had to work."],
        ],
      },
    ],
  },
...
function NoteBox({ text, yellow }) {
  return (
    <div style={{
      background: yellow ? "#fffbea" : "#f0f7f4",
      border: `1px solid ${yellow ? "#f0d070" : "#a8d4c4"}`,
      borderRadius: 6,
      padding: "0.4rem 0.75rem",
      marginBottom: "0.65rem",
      fontSize: "0.8rem",
      color: yellow ? "#7a5500" : "#1e4035",
      lineHeight: 1.5,
    }}>
      {text}
    </div>
  ...
  return (
    <div style={{
      ...
      <button onClick={() => setOpen(o => !o)} style={{
        ...
        background: open ? "#1e3d32" : "#f0ece6",
        color: open ? "#e8f0ec" : "#1e3d32",
        border: "none", cursor: "pointer",
        fontFamily: "Georgia, serif", fontSize: "0.9rem",
        fontWeight: 700, letterSpacing: "0.01em", transition: "all 0.18s",
      }}>
        <span>{s.title}</span>
      ...
      {open && (
        <div style={{ padding: "0.85rem 1rem" }}>
          {s.note && <NoteBox text={s.note} yellow />}
          {s.note2 && <NoteBox text={s.note2} />}
              ...
              <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "0.84rem" }}>
                <thead>
                  <tr>
                    {s.headers.map((h, i) => (
                      <th key={i} style={{
                        textAlign: "left", padding: "0.3rem 0.55rem",
                        borderBottom: "2px solid #1e3d32", color: "#1e3d32",
          ...
          {s.type === "grid" && (
            <div style={{ display: "grid", gap: "0.35rem" }}>
              {s.rows.map((row, i) => (
                <div key={i} style={{ display: "grid", gridTemplateColumns: "repeat(6,1fr)", gap: "0.3rem" }}>
                  {row.map((cell, j) => cell ? (
                    <div key={j} style={{
                      background: "#edf5f1", borderRadius: 6,
                      padding: "0.3rem 0.4rem", fontSize: "0.8rem",
                      fontWeight: 700, color: "#1e3d32", textAlign: "center",
            ...
            <ul style={{ listStyle: "none", padding: 0, margin: 0 }}>
              {s.notes.map((n, i) => (
                <li key={i} style={{
                  ...
                  borderBottom: i < s.notes.length - 1 ? "1px solid #ede7df" : "none",
                  fontSize: "0.84rem", color: "#1a2e28", lineHeight: 1.55,
                  fontFamily: n.startsWith("─") ? "Georgia, serif" : "inherit",
                  fontWeight: n.startsWith("─") ? 700 : 400,
                }}>{n}</li>
              ))}
            </ul>
          )}
...
export default function App() {
  const [book, setBook] = useState("A1.1");
  const [tab, setTab] = useState("grammar");
  const [search, setSearch] = useState("");

  const sections = BOOKS[book][tab] || [];

  const filtered = search.trim()
    ? sections.filter(s =>
        s.title.toLowerCase().includes(search.toLowerCase()) ||
        (s.rows && s.rows.some(r => r.some(c => c.toLowerCase().includes(search.toLowerCase())))) ||
        (s.notes && s.notes.some(n => n.toLowerCase().includes(search.toLowerCase())))
      )
    : sections;

  return (
    <div style={{ minHeight: "100vh", background: "#f2ede7", fontFamily: "'Segoe UI', system-ui, sans-serif" }}>
      {/* Header */}
      <div style={{ background: "#1e3d32", paddingBottom: 0 }}>
        <div style={{ maxWidth: 720, margin: "0 auto", padding: "1rem 1rem 0" }}>
          {/* Title row */}
          <div style={{ display: "flex", alignItems: "center", gap: "0.75rem", marginBottom: "0.3rem" }}>
            <h1 style={{
              margin: 0, fontSize: "1.4rem", fontFamily: "Georgia, serif",
              color: "#e8f0ec", fontWeight: 700,
            }}>Deutsch Spickzettel</h1>
            <span style={{
              background: "#c8a84b", color: "#1a2000", fontSize: "0.68rem",
              fontWeight: 800, padding: "0.15rem 0.5rem", borderRadius: 20, letterSpacing: "0.06em",
            }}>Starten Wir!</span>
          </div>
          <p style={{ margin: "0 0 0.8rem", color: "#7aaf98", fontSize: "0.78rem" }}>
            Grammar-focused cheat sheet · Updated content
          </p>

          {/* Book switcher */}
          <div style={{ display: "flex", gap: "0.4rem", marginBottom: "0.75rem" }}>
            {["A1.1", "A1.2", "A2.1", "A2.2"].map(b => (
              <button key={b} onClick={() => { setBook(b); setTab("grammar"); setSearch(""); }} style={{
                padding: "0.35rem 1rem", borderRadius: 20, border: "2px solid",
                borderColor: book === b ? "#c8a84b" : "#3d6455",
                background: book === b ? "#c8a84b" : "transparent",
                color: book === b ? "#1a2000" : "#7aaf98",
          ...
          <div style={{ display: "flex", gap: "0.2rem" }}>
            {TABS.map(t => (
              <button key={t.id} onClick={() => { setTab(t.id); setSearch(""); }} style={{
                ...
                background: tab === t.id ? "#f2ede7" : "transparent",
                color: tab === t.id ? "#1e3d32" : "#7aaf98",
      ...
      <div style={{ maxWidth: 720, margin: "0 auto", padding: "1rem" }}>
        <input
          ...
          style={{
            ...
            border: "1px solid #ccc6be", borderRadius: 8,
            fontSize: "0.85rem", background: "#fff", color: "#1a2e28",
            outline: "none", boxSizing: "border-box", marginBottom: "1rem",
          }}
        />

        {filtered.length === 0
          ? <p style={{ color: "#9a8a7a", textAlign: "center", padding: "2rem" }}>Keine Ergebnisse.</p>
          : filtered.map((s, i) => <Section key={i} s={s} />)
        }

        <p style={{ textAlign: "center", fontSize: "0.72rem", color: "#b0a090", padding: "0.5rem 0 2rem" }}>
          📌 Tell Claude which chapter you finished to keep this updated
        </p>
      </div>
    </div>
  );
